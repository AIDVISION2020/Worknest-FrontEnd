...
import { registerAdmin } from "../../../api/auth"; // Adjust the import path as necessary
...
function AdminRegisterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/user-admin/login'); // Redirect to login page after successful registration
    } catch (error) {
      ...
      <div className="center-wrapper">
        ...
        onChange={handleChange} required/>
                ...
                <div className="registration-link">
                    <p>Already have an account? <Link to="/user-admin/login">Login</Link></p>
                </div>
            </form>
        </div>
      </div>
