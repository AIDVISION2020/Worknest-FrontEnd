...
import Tickets from '../../../components/worker/Tickets'; // Adjust the import path as necessary
    ...
    <div className="app-layout">
      ...
      <header className="header">
        ...
        <div className="nav-right">
          ...
          <div className="dropdown-menu">
            <span className='profile-dropdown'><Link to="/worker/profile">Profile</Link></span>
      ...
      <div className="dashboard-body">
        ...
        <main className="main-content" onClick={handleMainClick}>
          <h2>Welcome to your Worker dashboard!</h2>
          <Tickets />
        </main>
      </div>
